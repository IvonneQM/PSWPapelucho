{{-- Modal --}}
<div class="modal fade" id="modal-editar-administrador" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="id_form_admin" method="PUT" action="{{route('administrador.administradores.update')}}">
                    ...
                    <div class="form-group">
                        {!!Form::label('rut','Rut: ')!!}
                        {!!Form::text('rut',null,['class'=>'form-control rut', 'id'=>'rutAdmin', 'placeholder'=>'Rut usuario'])!!}
                    ...
                    <div class="form-group">
                        ...
                        {!!Form::text('email',null,['class'=>'form-control', 'id'=>'emailAdmin', 'placeholder'=>'Email de usuario', 'autocomplete' => 'off'])!!}
                    </div>
                    <div class="form-group">
