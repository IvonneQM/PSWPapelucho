{{-- Modal --}}
<div class="modal fade" id="modal-editar-apoderado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="id_prueba" method="PUT" action="{{route('administrador.apoderados.update')}}">
                    ...
                    <div class="form-group">
                        ...
                        {!!Form::text('email',null,['class'=>'form-control', 'id'=>'emailApo', 'placeholder'=>'Email de usuario', 'autocomplete' => 'off'])!!}
                    </div>
                    <div class="form-group">
