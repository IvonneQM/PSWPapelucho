    ...
    <div class="container" style="width: 100%">
        <div class="row-fluid">
            <div class="col-lg-12">
                ...
                <div class="panel-heading container-title"><h1 class="title">Galerías</h1></div>
                <div class="col-lg-12 div-btn">
                    ...
                    {!! Form::close()  !!}
                    <a class="btn btn-primary pull-right btn-crear-nuevo" id="register-galeria" href="#" role="button">
                        <i class="fa fa-picture-o"> <span class="button-title">Crear Galeria</span></i></a>
                </div>
                <div class="panel-body">
                    <div id="list-galerias">
                        {{--Tabla lista galerias partials/table--}}
                    </div>
                </div>
            </div>
        </div>
