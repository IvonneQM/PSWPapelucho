            ...
            <div id="lMenor" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <p> Generar un ambiente cálido, adecuado y de entrega pedagógica, para lograr en los
                        lactantes un
                        desarrollo óptimo en todos los ámbitos de aprendizajes, siendo a la vez un aporte a las madres
                        que
                        trabajan.</p>
                </div>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div id="lMayor" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <h4 class="cursive-title">Descripción</h4>
                    <p>El grupo está formado por lactantes de 12 a 24 meses de edad, los cuales están a cargo de
        ...
        <div class="panel panel-default">
            ...
            <div id="mMenor" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <h4 class="cursive-title">Descripción</h4>
                    <p>Este Nivel atiende a párvulos entre los 2 años y 2 años 11 meses, , los cuales están a cargo de
                        Educadora y Asistente de
                        Párvulos. </p>
                    <h4 class="cursive-title">Objetivos</h4>
            ...
            <div id="mMayor" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <p>Adquirir gradualmente una autonomía que le permita un desarrollo integral en los
                        ámbitos de:
                        Formación Personal y Social, Relación con el medio natural y cultural y Comunicación,
                        propiciando un
