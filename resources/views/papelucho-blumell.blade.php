    ...
    <div class="accordion" id="accordion">
        <div>
            ...
            <div class="accordion-item-content">
                <p>El trabajo pedagógico, tanto en la Escuela de Párvulos como en la Sala Cuna, se desarrolla de acuerdo a las nuevas bases curriculares de la Educación Parvularia, complementadas con la utilización de los Mapas de Progresos sugeridos por MINEDUC. El trabajo pedagógico, tanto en la Escuela de Párvulos como en la Sala Cuna, se desarrolla de acuerdo a las nuevas bases curriculares de la Educación Parvularia, complementadas con la utilización de los Mapas de Progresos sugeridos por MINEDUC. </p>
        ...
        <div>
            ...
            <div class="accordion-item-content">
                ...
                <p>Este nivel atiende a lactantes desde 84 días a 12 meses, los cuales son atendidos por una Educadora y dos Asistentes de Párvulos quienes velan por el bienestar de los pequeños y propician su desarrollo integral a través de variadas situaciones de aprendizaje. </p>
                <h4>Objetivos</h4>
        ...
        <div>
            ...
            <div class="accordion-item-content">
                <h4>Descripción</h4>
                <p>Este nivel se compone  por lactantes de 12 a 24 meses de edad y es atendido por una Educadora y dos Asistentes de Párvulos. Este grupo se caracteriza por adquirir progresivamente mayor seguridad y autonomía en lo que realizan, mostrándose más sociables y con confianza en sí mismos. </p>
                <h4>Objetivos</h4>
        ...
        <div>
            ...
            <div class="accordion-item-content">
                <h4>Descripción</h4>
                <p>Este Nivel se compone de dos grupos que funcionan en ambas jornadas y atiende a párvulos entre los 2 y 2 años 11 meses, los cuales son atendidos por una Educadora y dos Asistentes de Párvulos en cada Nivel. </p>
                <h4>Objetivos</h4>
                <p>Propicia un desarrollo integral a través de diversos aprendizajes significativos que se plantean en forma equilibrada según intereses y necesidades de los párvulos, dando especial énfasis a los ámbitos de comunicación y formación personal y social.</p>
            </div>
        </div>
        <div>
            <div class="accordion-item-title">
            ...
            <div class="accordion-item-content">
                <h4>Descripción</h4>
                <p>El nivel atiende a niños(as), cuyas edades fluctúan entre los 3 y 3 años 11 meses. Está a cargo de una Educadora y una Asistente de Párvulos. </p>
                <h4>Objetivos</h4>
